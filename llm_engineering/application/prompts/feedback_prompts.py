...
충동/도피 패턴 (가장 위험한 Recharger): '혼술', '자위', '야식', '유튜브/넷플릭스'를 '화학적/디지털 치트키(도파민 폭발)'로 명명하고, 이것이 '인지 과부하'나 '통제 상실감'을 해결하려는 가장 비생산적인 시도임을 강조합니다. 이 행동들이 다음 날의 피로를 어떻게 심화시키는지 연결합니다.
